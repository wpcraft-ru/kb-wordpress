• PrologueRelease NotesUpgrade GuideContribution Guide
• Getting StartedInstallationConfigurationDirectory StructureFrontendStarter KitsDeployment
Getting Started
• Architecture ConceptsRequest LifecycleService ContainerService ProvidersFacades
Architecture Concepts
• The BasicsRoutingMiddlewareCSRF ProtectionControllersRequestsResponsesViewsBlade TemplatesAsset BundlingURL GenerationSessionValidationError HandlingLogging
The Basics
• Digging DeeperArtisan ConsoleBroadcastingCacheCollectionsConcurrencyContextContractsEventsFile StorageHelpersHTTP ClientLocalizationMailNotificationsPackage DevelopmentProcessesQueuesRate LimitingStringsTask Scheduling
Digging Deeper
• SecurityAuthenticationAuthorizationEmail VerificationEncryptionHashingPassword Reset
• DatabaseGetting StartedQuery BuilderPaginationMigrationsSeedingRedisMongoDB
• Eloquent ORMGetting StartedRelationshipsCollectionsMutators / CastsAPI ResourcesSerializationFactories
Eloquent ORM
• TestingGetting StartedHTTP TestsConsole TestsBrowser TestsDatabaseMocking
• PackagesBreezeCashier (Stripe)Cashier (Paddle)DuskEnvoyFortifyFolioHomesteadHorizonJetstreamMCPMixOctanePassportPennantPintPrecognitionPromptsPulseReverbSailSanctumScoutSocialiteTelescopeValet
API Documentation
WARNING You're browsing the documentation for an old version of Laravel. Consider upgrading your project to Laravel 13.x.
WARNING You're browsing the documentation for an old version of Laravel. Consider upgrading your project to Laravel 13.x.
Installation
• Meet Laravel Why Laravel?
• Creating a Laravel Application Installing PHP and the Laravel Installer Creating an Application
• Installing PHP and the Laravel Installer
• Creating an Application
• Initial Configuration Environment Based Configuration Databases and Migrations Directory Configuration
• Environment Based Configuration
• Databases and Migrations
• Directory Configuration
• Local Installation Using Herd Herd on macOS Herd on Windows
• Docker Installation Using Sail Sail on macOS Sail on Windows Sail on Linux Choosing Your Sail Services
• Choosing Your Sail Services
• Laravel and AI Installing Laravel Boost
• Installing Laravel Boost
• Next Steps Laravel the Full Stack Framework Laravel the API Backend
...
1curl -s "https://laravel.build/example-app" | bash curl -s "https://laravel.build/example-app" | bash
...
1cd example-app2 3./vendor/bin/sail up cd example-app ./vendor/bin/sail up
Once the application's Docker containers have started, you should run your application's database migrations:
1./vendor/bin/sail artisan migrate ./vendor/bin/sail artisan migrate
...
1docker context use default docker context use default
...
1curl -s "https://laravel.build/example-app?with=mysql,redis" | bash curl -s "https://laravel.build/example-app?with=mysql,redis" | bash
...
1curl -s "https://laravel.build/example-app?with=mysql,redis&devcontainer" | bash curl -s "https://laravel.build/example-app?with=mysql,redis&devcontainer" | bash
IDE Support
...
On this page
• Meet LaravelWhy Laravel?
• Creating a Laravel ApplicationInstalling PHP and the Laravel InstallerCreating an Application
• Installing PHP and the Laravel Installer
• Creating an Application
• Initial ConfigurationEnvironment Based ConfigurationDatabases and MigrationsDirectory Configuration
• Environment Based Configuration
• Databases and Migrations
• Directory Configuration
• Local Installation Using HerdHerd on macOSHerd on Windows
• Docker Installation Using SailSail on macOSSail on WindowsSail on LinuxChoosing Your Sail Services
• Choosing Your Sail Services
• Laravel and AIInstalling Laravel Boost
• Installing Laravel Boost
• Next StepsLaravel the Full Stack FrameworkLaravel the API Backend
• Laravel the Full Stack Framework
• Laravel the API Backend
