...
## [2026-07-25] update | Переименование в База знаний WPC

- Выполнено фактическое переименование названия базы знаний: `Web Production Craft` -> `WPC` в пользовательских заголовках.
- Обновлены ключевые файлы: `README.md`, `astro.config.mjs`, `src/content/docs/index.md`, `AGENTS.md`.
- Причина: синхронизировать брендирование с пунктом дорожной карты.
...
- Добавлены: рейтинг направлений, вариации, сценарии использования и опции/расширения для ключевых типов проектов.
- Причина: детализировать продуктовую линейку агентства для упаковки и пресейла.
...
- Синхронизированы оглавление базы знаний и `README.md`.
