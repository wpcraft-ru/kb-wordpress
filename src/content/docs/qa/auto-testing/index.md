...
> Подробнее: [Стратегия тестирования WordPress](../testing-strategy.md)
...
- [Стратегия тестирования WordPress](../testing-strategy.md) — Общая стратегия: автоматизация, ручное тестирование, риск-ориентированный подход, трофей тестирования.
