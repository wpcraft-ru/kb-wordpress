...
description: "Обзор S3-совместимых объектных хранилищ для WordPress: российские (Yandex, Selectel, VK Cloud) и международные (AWS S3, Cloudflare R2, DigitalOcean Spaces, MinIO) — цены, классы, сравнение."
---

## Обзор

S3-совместимое объектное хранилище — основа для выноса медиафайлов WordPress из `wp-content/uploads`. Все провайдеры в этом обзоре поддерживают S3 API, что позволяет использовать любой [плагин offload](../../plugins/s3-storage.md) без смены архитектуры.
