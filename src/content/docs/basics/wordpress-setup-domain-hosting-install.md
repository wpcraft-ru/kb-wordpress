...
- [WordPress на Beget](../platforms/wordpress/wordpress-on-beget.md) — VPS через Marketplace
- [WordPress на Timeweb](../platforms/wordpress/wordpress-on-timeweb.md) — Ручная и автоустановка
